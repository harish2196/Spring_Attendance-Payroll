...
.logo {
	...
	letter-spacing: 20px;
	color: lavenderblush;
	text-shadow: 12px 13px 8px rgba(2, 0, 1, 0.3);
...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav ml-auto">
					...
					<div>
						<p
							style="color: white; margin-top: 6.7%; bottom: 0;margin-left=-60%">
							Welcome,
	...
	<nav class="custom-nav">
		...
		<div class="custom-dropdown">
			<form action="/timeSheet" class="a1" method="post">
				<button class="custom-dropbtn">
					Timesheet <i class="fa fa-caret-down"></i>
				</button>
			</form>
			</a>
		</div>
	...
	<div class="para">
		<p>Managing attendance and zpayroll efficiently is crucial for any
			organization to ensure accurate compensation and regulatory
			compliance. By leveraging advanced software solutions, companies can
			automate attendance tracking, leave management, and payroll
			processing, thereby reducing errors and saving time.</p>
	</div>
	<div class="para1">
		<p>Allow your employees to mark attendance easily on the web. All
			they need is an internet connection and our URL to log in and log out
			for the day.</p>
	</div>
	<div class="box">
		<div class="box1">
		...
		<div class="box2">
			...
			<p>
				...
				"Payroll management ensures timely employee compensation, fostering
				morale and maintaining organizational efficiency, thereby <span
					style="color: darkmagenta;"> contributing to sustained
					success and employee satisfaction."</span>
			</p>
			</span>
		</div>
	</div>
		...
		<div class="footer-container">
			...
			<div class="footer-bottom">
				<div class="footer-locations">
					<a href="#">Sivakasi</a> <a href="#">Chennai</a> <a href="#">Bangalore</a>
					<a href="#">Hyderabad</a> <a href="#">Bangladesh</a>
				</div>
    ...
    <script type="text/javascript">
        ...
        if(status === "failed") {
            Swal.fire({
                icon: 'warning',
                title: 'Sorry!',
                text: 'Your payslip has not been initiated by Manager!'
            });
        }
    </script>
