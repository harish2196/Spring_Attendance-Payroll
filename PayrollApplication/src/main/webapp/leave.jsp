...
<input type="hidden" id="status" value="<%= request.getAttribute("status") %>">
    ...
    <form class="leave-form" action="/leave" method="post" onsubmit="return validateDates()">
        ...
        <input type="date" id="fromDate" name="fromDate" required min="2024-07-01" max="2024-07-30">
        
        <label for="toDate">To Date</label>
        <input type="date" id="toDate" name="toDate" required min="2024-07-02" max="2024-07-30">
